...
KEYCLOAK_REALM = os.getenv('KEYCLOAK_REALM', 'SecureAI')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'secureai_db'),
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'authentication.authentication.KeycloakJWTAuthentication',
    ),
    # By default require auth for all endpoints. We can override this per view.
